  ...
  return (
    <main className="flex-1 p-4 flex flex-col">
      ...
      <button
        ...
        disabled={false} // Always allow toggling when authenticated
        className={`relative w-24 h-24 rounded-full mx-auto mb-6 flex items-center justify-center transition-all ${
          isPluginActive 
            ? 'bg-green-500/20 hover:bg-green-500/30 shadow-lg border-2 border-green-400' 
            : 'bg-red-500/10 hover:bg-red-500/20 border-2 border-red-400'
        }`}
      >
        <svg 
          width="32" 
