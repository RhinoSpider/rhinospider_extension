...
# Script to directly add a topic to the admin canister using dfx with the fixed interface

echo "DIRECTLY ADDING TOPIC TO ADMIN CANISTER (FIXED INTERFACE)"
echo "=================================================="
...
# Create the argument for the createTopic call with the fixed interface
cat > $TEMP_FILE << EOL
(
  record {
    name = "Tech News";
