...
# Script to deploy the fixed admin canister with the correct interface

echo "DEPLOYING FIXED ADMIN CANISTER"
echo "==========================="
...
# Copy the fixed admin canister code
cp /Users/ayanuali/development/rhinospider/canisters/admin/admin-fixed.mo $TEMP_DIR/main.mo
echo "Copied fixed admin code to temp directory"
