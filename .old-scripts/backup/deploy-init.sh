...
# Script to deploy the admin canister with proper initialization

echo "DEPLOYING ADMIN CANISTER WITH PROPER INITIALIZATION"
echo "============================================="
...
# Copy the admin canister code with initialization
cp /Users/ayanuali/development/rhinospider/canisters/admin/admin-init.mo $TEMP_DIR/main.mo
echo "Copied admin code with initialization to temp directory"
