...
# Script to deploy the admin canister with exact interface matching

echo "DEPLOYING ADMIN CANISTER WITH EXACT INTERFACE"
echo "=========================================="
...
# Copy the exact admin canister code
cp /Users/ayanuali/development/rhinospider/canisters/admin/admin-exact.mo $TEMP_DIR/main.mo
echo "Copied exact admin code to temp directory"
